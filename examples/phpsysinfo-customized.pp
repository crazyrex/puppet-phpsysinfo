  ...
  class {
    'phpsysinfo':
      ...
      phpsysinfo_path         => "/usr/share/phpsysinfo/",  # The path where to extract phpsysinfo (Please do not forget the closing /)
                                                            ...
                                                            #
      default_theme           => "nextgen",                 # possible values: "aqua, clean, cream, jstyle_blue, jstyle_green, nextgen, phpsysinfo, two"
      display_theme_picker    => "false",
      default_language        => "en",                      # PhpSysInfo Language preferences
      display_language_picker => "false",
                                                            #
                                                            # Plugins Settings
                                                            #
      psstatus                => "true",                    # PSStatus - show a graphical representation if a process is running or not
      psstatus_processes_list => "sshd,apache2",            # the process list you want to monitor
      ps                      => "true",                    # PS - show a process tree of all running processes
