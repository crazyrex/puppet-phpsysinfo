...
node your_server_hostname {
  ...
  class {
    'phpsysinfo':
                                                            # Server configuration
                                                            #
      port_number             => "80",                      # The port number on which you will contact phpsysinfo
      admin_email_address     => "webmaster@localhost",     # The email address in the virtual host configuration file
      phpsysinfo_path         => "/var/www/",               # The path where to extract phpsysinfo (Please do not forget the closing /)
                                                            #
